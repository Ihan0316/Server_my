...
public class BlogSearchImpl extends QuerydslRepositorySupport
    ...
    public Page<Blog> search(Pageable pageable) {
        //예시,
        QBlog blog = QBlog.blog; // Q 도메인 객체, 엔티티 클래스(= 테이블)
        JPQLQuery<Blog> query = from(blog); // select * from blog 한 결과와 비슷함.
        //select * from blog 작성한 내용을 query 객체 형식으로 만듦.
        // 다양한 쿼리 조건을 이용할수 있음.
        ...
        booleanBuilder.or(blog.title.contains("3"));// "3" 제목 임시
